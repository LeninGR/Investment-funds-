...
public class WireDependencies {
    ...
    @Bean
    public HelperUseCase helperUseCase(FundRepository fundRepository, ClientRepository clientRepository) {
        return new HelperUseCase(fundRepository, clientRepository);
    }
}
