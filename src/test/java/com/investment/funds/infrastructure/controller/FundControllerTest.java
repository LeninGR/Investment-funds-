...
class FundControllerTest {
    ...
    @Test
    void shouldReturnBadRequestWhenSubscribeFailsWithBusinessException() throws Exception {
        // Arrange
        SubscribeRequest request = new SubscribeRequest();
        request.setClientId("client1");
        request.setFundId("fund1");
    ...
    @Test
    void shouldReturnBadRequestWhenCancelFailsWithBusinessException() throws Exception {
        // Arrange
        CancelSubscriptionRequest request = new CancelSubscriptionRequest();
        request.setClientId("client1");
        request.setFundId("fund1");
